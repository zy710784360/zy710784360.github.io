if (window.jsb) { 
    ...
    window._game_res_version = '1.0' 
    let version = localStorage.getItem('game_res_version') 
    if(version && version != window._game_res_version){ 
        if(jsb.fileUtils.isDirectoryExist(hotUpdateSearchPaths)) 
            console.log('remove old version file:'+jsb.fileUtils.removeDirectory(hotUpdateSearchPaths)) 
